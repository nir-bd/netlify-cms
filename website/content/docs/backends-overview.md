...
title: Overview
---
A backend is JavaScript code that allows Netlify CMS to communicate with a service that stores content - typically a Git host like GitHub or GitLab. It provides functions that Netlify CjkjhjMS can use to do things like read and update files using API's provided by the service.
